...
### RQ1 — Comparative analysis across patterns/strategies ([Docker/results/rq1.py](Docker/results/rq1.py))
...
- Quickstart:
  ```bash
  # From the repository root, after generating results with Docker scripts
  python3 Docker/results/rq1.py
  ```

### RQ2 — Predictor quality assessment ([Docker/results/rq2.ipynb](Docker/results/rq2.ipynb))
...
### RQ3 — Time-related analysis ([Docker/results/rq3.ipynb](Docker/results/rq3.ipynb))
...
If you are looking to run the experiments and produce the input data for these analyses, see [Docker/README.md](Docker/README.md) for the Quickstart using `run_experiments.sh` and `replication_script.sh`.